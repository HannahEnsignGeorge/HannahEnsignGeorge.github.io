...
<body>
	<h1 style="font-family:Verdana;font-size:30px;strong;align:center;">HTML In-Line Formtatting</h1>
	  <p style="font-family:Verdana;font-size:20px;">Want to change the color of your text in Timeline JS? Use HTML color codes, <a style="color:blue;" href="https://html-color-codes.info/">Link to the HTML color codes I used.</a></p>
